...
export class AddExperienceAddonPrice1786520103441 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "tier_configs" ADD "experienceAddonPriceKes" integer NOT NULL DEFAULT 300`);
    await queryRunner.query(`UPDATE "tier_configs" SET "experienceAddonPriceKes" = 500 WHERE "tier" = 'STARTER'`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "tier_configs" DROP COLUMN "experienceAddonPriceKes"`);
  }
}
